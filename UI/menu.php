<nav id='mnuTop' class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto right">
      <li class="nav-item"><div class="nav-link" onclick="nav('combate-def', this)"><i class="fas fa-fist-raised"></i> Nuevo Combate</div></li>
      <li class="nav-item"><div class="nav-link" onclick="nav('historial', this)"><i class="fas fa-book"></i> Combates grabados</div></li>
...
<div id='mnuBottom' class="fixed-bottom-menu">
  ...
  <div class="nav-link nav-selected" id='mnu-hist' onclick="nav('historial', this)"><i class="fas fa-book"></i></div>
